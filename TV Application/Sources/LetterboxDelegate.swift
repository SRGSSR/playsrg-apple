...
extension LetterboxDelegate: SRGLetterboxViewControllerDelegate {
    func letterboxViewController(_: SRGLetterboxViewController, didEngageInContinuousPlaybackWithUpcomingMedia upcomingMedia: SRGMedia) {
        AnalyticsEvent.continuousPlayback(action: .play,
                                          mediaUrn: upcomingMedia.urn)
            .send()
    }

    func letterboxViewController(_: SRGLetterboxViewController, didCancelContinuousPlaybackWithUpcomingMedia upcomingMedia: SRGMedia) {
