        ...
        var body: some View {
            HStack(alignment: .top, spacing: 30) {
                ...
                LabeledButton(icon: model.isWatchedLater ? "watch_later_full-22" : "watch_later-22",
                              label: model.isWatchedLater ? NSLocalizedString("Later", comment: "Watch or listen later button label in media detail view when a media is in the watch later list") : NSLocalizedString("Add to \"Watch later\"", comment: "Button label in media detail view to add a media to the watch later list"),
                              accessibilityLabel: model.isWatchedLater ? PlaySRGAccessibilityLocalizedString("Remove from the watch later list", "Media watch later removal label in the media detail view when a media is in the watch later list") : PlaySRGAccessibilityLocalizedString("Add to the watch later list", "Media watch later label in media detail view to add a media to the watch later list")) {
