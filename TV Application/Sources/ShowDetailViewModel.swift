...
class ShowDetailViewModel: ObservableObject {
    ...
    func refresh() {
        ...
        SRGDataProvider.current!.latestMediasForShow(withUrn: show.urn, pageSize: ApplicationConfiguration.shared.pageSize, paginatedBy: trigger.signal(activatedBy: Self.triggerIndex))
