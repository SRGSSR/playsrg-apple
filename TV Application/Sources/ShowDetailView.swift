    ...
    private struct VisualView: View {
        ...
        private func favoriteRemovalAlert() -> Alert {
            ...
            return Alert(title: Text(NSLocalizedString("Remove from favorites", comment: "Title of the confirmation pop-up displayed when the user is about to remove a favorite")),
                         message: Text(NSLocalizedString("You have subscribed to notifications for this show on other devices logged with the same account. Removing this favorite will unsubscribe all devices from push notifications.", comment: "Confirmation message displayed when a logged in user is about to remove a favorite")),
