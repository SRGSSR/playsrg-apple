...
- (NSArray<id<UIPreviewActionItem>> *)previewActionItems
{
    ...
    if (WatchLaterCanStoreMediaMetadata(self.media)) {
        ...
        UIPreviewAction *watchLaterAction = [UIPreviewAction actionWithTitle:inWatchLaterList ? NSLocalizedString(@"Remove from \"Later\"", @"Button label to remove a media from the later list, from the media preview window") : addActionTitle style:inWatchLaterList ? UIPreviewActionStyleDestructive : UIPreviewActionStyleDefault handler:^(UIPreviewAction * _Nonnull action, UIViewController * _Nonnull previewViewController) {
