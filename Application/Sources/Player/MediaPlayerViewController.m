...
- (void)letterboxViewWillAnimateUserInterface:(SRGLetterboxView *)letterboxView
{
    ...
    [letterboxView animateAlongsideUserInterfaceWithAnimations:^(BOOL hidden, BOOL minimal, CGFloat aspectRatio, CGFloat heightOffset) {
        ...
        SRGMedia *mainMedia = self.letterboxController.play_mainMedia;
        CGFloat verticalFillRatio = ((NSInteger)mainMedia.mediaType == (NSInteger)SRGMediaPlayerMediaTypeVideo) ? 0.5f : 0.4f;
...
- (NSArray<UIKeyCommand *> *)keyCommands
{
    ...
    togglePlayPauseCommand.discoverabilityTitle = ((NSInteger)self.letterboxController.resource.streamType == (NSInteger)SRGMediaPlayerStreamTypeLive) ? NSLocalizedString(@"Play / Stop", @"Play / Stop shortcut label") : NSLocalizedString(@"Play / Pause", @"Play / Pause shortcut label");
