...
- (void)synchronizeUserActivity:(NSUserActivity *)userActivity
{
    ...
    if (mainChapterMedia) {
        ...
        userActivity.webpageURL = [ApplicationConfiguration.sharedApplicationConfiguration sharingURLForMediaMetadata:mainChapterMedia channel:mainChapterMedia.channel atTime:currentTime];
...
- (void)updateSharingStatusForMedia:(SRGMedia *)media
{
    if (self.letterboxController.continuousPlaybackUpcomingMedia) {
        ...
        self.shareButton.hidden = ([ApplicationConfiguration.sharedApplicationConfiguration sharingURLForMediaMetadata:media channel:media.channel atTime:kCMTimeZero] == nil);
    }
}
