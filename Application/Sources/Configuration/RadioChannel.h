...
OBJC_EXPORT UIImage *RadioChannelSquareLogoImage(RadioChannel * _Nullable radioChannel);
OBJC_EXPORT UIImage *RadioChannelSquareLargeLogoImage(RadioChannel * _Nullable radioChannel);
