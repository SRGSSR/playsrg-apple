 ...
 */
- (nullable NSURL *)sharingURLForMediaMetadata:(nullable id<SRGMediaMetadata>)mediaMetadata channel:(nullable SRGChannel *)channel atTime:(CMTime)time; // Use kCMTimeZero to start at the default location.
