...
final class OnboardingViewController: BaseViewController {
    ...
    @IBAction private func previousPage(_: UIButton) {
        paperOnboarding.currentIndex(paperOnboarding.currentIndex - 1, animated: true)
    }

    @IBAction private func close(_: UIButton) {
    ...
    @IBAction private func nextPage(_: UIButton) {
        paperOnboarding.currentIndex(paperOnboarding.currentIndex + 1, animated: true)
    }

    // MARK: Notifications

    @objc private func accessibilityVoiceOverStatusChanged(notification _: NSNotification) {
