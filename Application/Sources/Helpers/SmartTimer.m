...
+ (SmartTimer *)timerWithTimeInterval:(NSTimeInterval)interval
                              repeats:(BOOL)repeats
                           background:(BOOL)background
                                queue:(dispatch_queue_t)queue
                                block:(void (^)(void))block
{
    return [[SmartTimer alloc] initWithTimeInterval:interval repeats:repeats background:background queue:queue block:block];
}
