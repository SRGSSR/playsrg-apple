...
const CGFloat LayoutTableViewdMargin = 8.f;

UIEdgeInsets LayoutTableViewPaddingContentInsets()
{
    return UIEdgeInsetsMake(LayoutTableViewdMargin / 2, 0., LayoutTableViewdMargin / 2, 0.);
}
